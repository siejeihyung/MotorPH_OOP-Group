...
public abstract class Employee implements IPayable {
    ...
    public Employee(String employeeID, String lastName, String firstName, 
                    double basicSalary, double semiMonthlyRate, double hourlyRate, Benefits benefits) {
    ...
    public Benefits getBenefits() { return benefits; } // Common Concrete Methods: Standard logic used by all subclasses
